    ...
    <div class="w-dyn-items"><div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Ilayaraja concert at Marina Mall</div>
            </div>
            <div class="w-col w-col-3">
              <div>Marina Mall,Chennai</div>
            </div>
            <div class="w-col w-col-2">
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Yuvan Conecert at Nehru Stadium</div>
            </div>
            <div class="w-col w-col-3">
              <div>Nehru Stadium, Chennai</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Ar Rahman at Besant nagar</div>
            </div>
            <div class="w-col w-col-3">
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Vijay Antony Concert at Anna Nagar</div>
            </div>
            <div class="w-col w-col-3">
          ...
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">G.V Prakesh Concert at ECR</div>
            </div>
            <div class="w-col w-col-3">
              <div>ECR, Chennai</div>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">jonita gandhi Concert at OMR </div>
            </div>
            <div class="w-col w-col-3">
              <div> OMR , Chennai</div>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Hip Hop Tamizha concert at ECR</div>
            </div>
            <div class="w-col w-col-3">
              <div>ECR , Chennai</div>
            </div>
        ...
        <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Andrea Jeremiah Concert at OMR </div>
            </div>
            <div class="w-col w-col-3">
              <div>OMR ,Chennai</div>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Pradeep Kumar Concert at Gandhi Park</div>
            </div>
            <div class="w-col w-col-3">
              <div>Gandhi park, Chennai</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Aniruth Concert at Anna University</div>
            </div>
            <div class="w-col w-col-3">
              <div>Anna University, Madras</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">S.P.B. Charan Concert at ECR</div>
            </div>
            <div class="w-col w-col-3">
              <div>ECR, Chennai</div>
            </div>
          ...
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue"> Shruti Haasan Concert at Railway Ground</div>
            </div>
            <div class="w-col w-col-3">
              <div>Railway Ground, Tambaram </div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Harris Jayaraj Concert at OMR</div>
            </div>
            <div class="w-col w-col-3">
              <div>OMR, Chennai</div>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            <div class="w-col w-col-2">
              <div>Augest 2, 2024</div>
            </div>
            <div class="w-col w-col-5">
              <div class="venue">shreya ghoshal concert at phoenix mall</div>
            </div>
            <div class="w-col w-col-3">
              <div>phoenix mall, velachery</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
